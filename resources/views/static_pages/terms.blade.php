    ...
    <div class="panel-body">
        ...
        <div class="example-box-wrapper">
            <form class="form-horizontal bordered-row" enctype="multipart/form-data" method="post"
                action="{{url('/backoffice/termsupdate')}}">
                {{ csrf_field() }}
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="input-mask form-control" name="heading" value="{{ $terms->heading }}" required>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <textarea name="description" required rows="10" class="ckeditor " required>{{htmlspecialchars_decode(html_entity_decode($terms->description))}}</textarea>
                    </div>
                </div>
