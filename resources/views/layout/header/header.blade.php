                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item dropdown header-profile">
								...
								<?php
				$data=DB::table('users_system')->where('users_system_id', session()->get('id'))->get();
				?>
                                    <img src="{{asset('uploads/users/'.  $data[0]->user_image)}}" width="60" style="height: 60px; width: 60px; border-radius: 50%;" alt=""/>
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a href="{{url('/new_logout')}}" class="dropdown-item ai-icon">
