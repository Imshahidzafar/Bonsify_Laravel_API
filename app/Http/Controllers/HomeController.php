 ...
 */
 ...
 // ------------- MANAGE CATEGORIES CRUD -------------- //
    ...
    public function manage_categories(Request $request){
        if ($request->session()->has('id')) {
            ...
            return view('manage_system.categories.manage_categories', compact('categories'));
        }
        return view('login');
    }
    ...
    public function add_category(Request $req){
        ...
        if($a){
            return redirect('/manage_categories')->with('success', 'Category Added successfully');
        }else{
            abort(403, "Forbidden");
        }
    }
 ...
 // ------------- MANAGE DRESS CODES CRUD -------------- //
    // Manage Dresscodes
    public function manage_dresscodes(Request $request){
        if ($request->session()->has('id')) {
            $dresscodes= db::table('dress_code')->get();
            return view('manage_system.dresscodes.manage_dresscodes', compact('dresscodes'));
        }
        return view('login');
    }
 ...
 // ------------- MANAGE EVENT TYPES CRUD -------------- //
    ...
    public function manage_eventtypes(Request $request){
        if ($request->session()->has('id')) {
            ...
            return view('manage_system.eventtypes.manage_eventtypes', compact('eventtypes'));
        }
        return view('login');
    }
 ...
 // ------------- MANAGE PREDEFINED TAGS CRUD -------------- //
    ...
    public function manage_tags(Request $request){
        if ($request->session()->has('id')) {
            ...
            return view('manage_system.tags.manage_tags', compact('tags'));
        }
        return view('login');
    }
 ...
 // ------------- MANAGE USER CATEGORIES CRUD -------------- //
    ...
    public function manage_usercategories(Request $request){
        if ($request->session()->has('id')) {
            ...
            return view('users.manage_usercategories', compact('usercategories'));
        }
        return view('login');
    }
 ...
 // ------------- MANAGE CARDS CRUD -------------- //
    ...
    public function manage_cards(Request $request){
        if ($request->session()->has('id')) {
            ...
            return view('payments_management.manage_cards', compact('cards'));
        }
        return view('login');
    }
 ...
 // ------------- MANAGE CONNCASH CRUD -------------- //
    ...
    public function manage_conncash(Request $request){
        if ($request->session()->has('id')) {
            ...
            return view('payments_management.manage_conncash', compact('allconncash'));
        }
        return view('login');
    }
...
//        dd($response);
    ...
    public function add_conncash(Request $req){
        ...
        $insert['conncash_source'] = $req->conncash_source;
            ...
            if($a){
                return redirect('/manage_conncash')->with('success', 'Conncash Details Added successfully');
            }else{
                abort(403, "Forbidden");
            }
 ...
 // ------------- MANAGE ADDRESSES CRUD -------------- //
    ...
    public function manage_addresses(Request $request){
        if ($request->session()->has('id')) {
            ...
            return view('events.manage_addresses', compact('addresses'));
        }
        return view('login');
    }
...
/*     // Add Address
 ...
 // ------------- MANAGE EVENT TICKETS CRUD -------------- //
    // Manage cards
    public function manage_eventtickets(Request $request){
        if ($request->session()->has('id')) {
            $event_tickets= db::table('tickets')->get();
            return view('events.manage_eventtickets', compact('event_tickets'));
        }
        return view('login');
    }
    ...
    public function add_eventticket(Request $req){
        ...
        if($a){
            return redirect('/manage_eventtickets')->with('success', 'Event Ticket Added successfully');
        }else{
            abort(403, "Forbidden");
        }
    }
 ...
 // ------------- MANAGE EVENT TAGS CRUD -------------- //
    // Manage Event Tags
    public function manage_eventtags(Request $request){
        if ($request->session()->has('id')) {
            $event_tags= db::table('event_tags')->get();
            return view('events.manage_eventtags', compact('event_tags'));
        }
        return view('login');
    }
    ...
    public function add_eventtag(Request $req){
        ...
        if($a){
            return redirect('/manage_eventtags')->with('success', 'Event tag Added successfully');
        }else{
            abort(403, "Forbidden");
        }
    }
 ...
 // ------------- MANAGE EVENT POSTS CRUD -------------- //
    // Manage EventPosts
    public function manage_eventposts(Request $request){
        if ($request->session()->has('id')) {
            $eventPosts= db::table('event_posts')->get();
            return view('events.manage_eventposts', compact('eventPosts'));
        }
        return view('login');
    }
    ...
    public function add_eventpost(Request $req){
        ...
        if($a){
            return redirect('/manage_eventposts')->with('success', 'Event Post Added successfully');
        }else{
            abort(403, "Forbidden");
        }
    }
...
// ================== PREVIOUS ADMIN PANEL FUNCTIONS =============== //
    ...
    public function email_templates(){
        ...
        return view('email.email_listing', compact('templates'));
    }

    public function post_template(){
        return view('email.add_email_templates');
    }

    public function view_templates($id=''){
        $templates= db::table('email_templates')->where('email_templates_id','=',$id)->first();
        return view('email.view_templates', compact('templates'));
    }
    ...
    public function listing_my_pending(){
        ...
        return view('listings.listing_my_pending', compact('listings'));
    }
    ...
    public function listing_my_active(){
        ...
        return view('listings.listing_my_active', compact('listings'));
    }
    /* MY Listings */
   ...
   /*  EDIT LISTING*/
    ...
    public function account_settings(){
        ...
        return view('users.account_settings',compact('data'));
    }
    /* Account Settings */
    ...
    public function profile_update(Request $req){
       ...
       $insert=array();
        ...
        $a = DB::table('users_system')->where('users_system_id','=',$req->id)->update($insert);
        if ($a) {
            return back()->with('success', 'Data Updated successfully');
        } else {
             return back()->with('errors', 'oops! something went wrong');
