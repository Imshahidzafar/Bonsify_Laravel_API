...
<div class="panel">
    <div class="panel-body">
        ...
        <h3 class="title-hero">User Categories Management {{-- <a data-toggle="modal" data-target="#Modal_add" class="btn btn-sm btn-primary" title=""
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                        <li><a id="{{ $items->user_category_id  }}" onclick="editItem('{{json_encode($items)}}')" >Edit </a></li>                                      
                                        <li><a id="{{ $items->user_category_id  }}" onclick="deleteItem('{{json_encode($items)}}')" >Delete </a></li>                                      
                                    </ul>
                                </div>
                            </td>
   ...
   {{--         <div class="modal fade" id="Modal_add" tabindex="-1" role="dialog" aria-labelledby="Modal_add" aria-hidden="true">
            <div class="modal-dialog" role="document">
                ...
                <form class="form-horizontal bordered-row" enctype="multipart/form-data" method="post" action="{{url('/add_usercategory')}}">
                {{ csrf_field() }}
        ...
        <div class="modal fade" id="Modal_edit" tabindex="-1" role="dialog" aria-labelledby="Modal_edit" aria-hidden="true">
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-body">
                <form class="form-horizontal bordered-row" id="itemForm" enctype="multipart/form-data" method="post" action="{{url('/usercategory_update')}}">
                {{ csrf_field() }}
                <input type="hidden" id="user_category_id" name="user_category_id">
        ...
        <div class="modal fade" id="Modal_delete" tabindex="-1" role="dialog" aria-labelledby="Modal_delete" aria-hidden="true">
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-body">
                <form class="form-horizontal bordered-row" id="itemForm" enctype="multipart/form-data" method="post" action="{{url('/delete_usercategory')}}">
                {{ csrf_field() }}
                <input type="hidden" id="user_category_id" name="user_category_id">
            ...
            <script>
                function editItem(item)
                {
                    ...
                    $("#itemForm input[name='user_category_id']").val(itemJson.user_category_id);
                    $("#itemForm input[name='users_id']").val(itemJson.users_id);
                    $("#itemForm #category_id").val(itemJson.category_id);
