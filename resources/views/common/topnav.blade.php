...
<div id="page-header" class="bg-gradient-9">
    <div id="mobile-navigation">
        ...
        <a href="{{url('/backoffice/')}}" class="logo-content-small" title="MonarchUI"></a>
    </div>
    <div id="header-logo" class="logo-bg">
        <a href="{{url('/backoffice/')}}" class="logo-content-big" title="Wan-You">
            Monarch <i>UI</i>
            ...
            <div class="dropdown-menu float-left">
                <div class="box-sm" style="width: 100px;">
                    <div class="pad5A button-pane button-pane-alt text-center">
                        <a href="{{url('logout')}}" class="btn display-block font-normal btn-danger" style="    width: 132px;">
